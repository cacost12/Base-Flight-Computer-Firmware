...
*                                                                              *
* DESCRIPTION:                                                                 *
*		Initializes the microcontroller I2C interface for use with the         *
...
*                                                                              *
* DESCRIPTION:                                                                 *
*		Initializes the buzzer timer/pwm interface to be used with the flight  *
*       computer piezo buzzer                                                  *
*                                                                              *
*******************************************************************************/
...
/*------------------------------------------------------------------------------
 Initializations 
------------------------------------------------------------------------------*/
pwm_period    = 20000;                          /* 6 kHz max frequency        */
